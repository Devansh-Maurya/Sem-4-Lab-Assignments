...
banner.setupDynamic = function() {
    this.animationSources = [ "js/160x600_intro.js" ];
    this.animationLibs = [ "lib_160x600_intro" ];
    this.animationSprites = [ "img/160x600_intro_atlas_.png" ];
    ...
    this.animationSources.push("js/160x600_outro.js");
    this.animationLibs.push("lib_160x600_outro");
    this.animationSprites.push("img/160x600_outro_atlas_.png");
